                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group bmd-form-group">
                                            ...
                                            <input type="text" name="title_seo" class="form-control" value="{{ old('title_seo' , $tag->title_seo) }}">
                                        </div>
                                        <div class="form-group bmd-form-group">
                                            <label class="bmd-label-floating">Keyword SEO </label>
                                            <input type="text" name="keyword_seo" class="form-control" value="{{ old('keyword_seo' , $tag->keyword_seo) }}">
                                        </div>
                                        <div class="form-group">
                                            <label>Description SEO</label>
                                            <div class="form-group bmd-form-group">
                                                <textarea name="description_seo" class="form-control" rows="5">{{ old('description_seo' , $tag->description_seo) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
