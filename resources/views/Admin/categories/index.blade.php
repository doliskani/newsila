                        ...
                        <div class="card-header card-header-tabs card-header-primary">
                            <div class="nav-tabs-navigation">
                                <div class="nav-tabs-wrapper d-flex justify-content-between">
                                    <span class="nav-tabs-title text-uppercase font-weight-bold">All categories</span>
                                    <a href="{{ route('categories.create') }}" type="button" rel="tooltip" title=""
                                ...
                                <div class="tab-pane active  table-responsive table-borderless" id="profile">
                                    <table class="table">
                                        ...
                                        @foreach($categories as $category)
                                            <tr>
                                                <td class="">
                                                    <i class="fa {{ $category->icon_class }} fa-2x text-warning"></i>
